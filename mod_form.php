...
class mod_mpgroup_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        #$mform->addRule('populationsize', get_string('err_numeric', 'mpgroup'), 'nonzero', null, 'client');
        ...
        #$mform->addRule('selectionoperator', get_string('err_numeric', 'mpgroup'), 'nonzero', null, 'client');
        ...
        #$mform->addRule('mutationoperator', get_string('err_numeric', 'mpgroup'), 'nonzero', null, 'client');
